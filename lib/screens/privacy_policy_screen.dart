...
*   **Google AdMob:** We use AdMob to display advertisements within the App. AdMob may collect anonymous data for ad personalization and measurement. This data collection is governed by Google's own privacy policy. We do not share your RoSpins username or specific game data with AdMob. For more information, please review the [Google Privacy & Terms](https://policies.google.com/privacy).
